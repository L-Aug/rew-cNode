<template>
    ...
    <div class="pt56" v-if="success">
      ...
      <div class="collect" v-if="userId"><mu-raised-button :label="collected?'取消收藏':'收藏'" class="demo-raised-button" :primary="!collected" :secondary="collected" @click="collect"/></div>
